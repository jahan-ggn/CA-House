...
import com.example.tjg.cahouseadmin.Adapters.RequestAdapter;
...
public class RequestActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ListView lvClientRequestedDocuments;
    AppConfig appConfig;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvClientRequestedDocuments = findViewById(R.id.lvClientRequestedDocuments);
    ...
    public void DisplayRequestDocuments() {
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, appConfig.getUrl() + "documentwebservice/select_client_inserted_documents.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (i = 0; i < jsonArray.length(); i++) {
                        ...
                        TotalList.add(map);
                        lvClientRequestedDocuments.setAdapter(new RequestAdapter(getApplicationContext(), TotalList, 1, RequestActivity.this));
    ...
    public void onClick(View v) {
        if(v == rbPending){
            lvClientRequestedDocuments.setAdapter(new RequestAdapter(getApplicationContext(), PendingList, 0, RequestActivity.this));
        }

        if(v == rbFulfilled){
            lvClientRequestedDocuments.setAdapter(new RequestAdapter(getApplicationContext(), FulfilledList, 1, RequestActivity.this));
        }
    }
